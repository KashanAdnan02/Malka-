...
// import { createShop, deleteShop, getShops, updateShop } from "@/lib/shops";

// const EMPTY = { shopName: "", ownerName: "", number: "", city: "" };
...
//     if (!form.shopName.trim() || !form.ownerName.trim() || !form.number.trim())
//       return notify("Please fill all required fields", "error");
//     setSaving(true);
//     if (editId) {
//       await updateShop(form, editId);
